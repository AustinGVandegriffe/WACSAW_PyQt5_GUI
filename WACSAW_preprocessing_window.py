...
import numpy as np
from WACSAW_act_sleep import *
from WACSAW_log_sleep import *
...
class PreprocessingWidgetSetup(object):
    ...
    def __init__(_,self):
        ...
        self.t01_button_browse_output.clicked.connect(lambda: self.browser(self.t01_line_edit_preprocessing_output_path))
